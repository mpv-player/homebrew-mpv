...
class Mpv < Formula
  url 'https://github.com/mpv-player/mpv/archive/v0.4.1.tar.gz'
  sha1 'e31a3f2714ad99181b3a9e849b2a5a4a40e955a2'
  ...
  def install
    ...
    args << "--enable-zsh-comp" if build.without? "no-zsh-comp"
